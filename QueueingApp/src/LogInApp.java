...
public class LogInApp extends JFrame {
	...
	public LogInApp() {
		...
		btnNewButton.setFont(new Font("Lucida Console", Font.PLAIN, 11));
		btnNewButton.setBounds(85, 250, 95, 25);
		...
		JLabel lblNewLabel = new JLabel("Queueing App Log-In");
